...
def analyze(file: str, language: str, summary_length: int, output: Optional[str], verbose: bool):
    """
    Analyze an audio file and generate a transcription with summary.
    
    Example:
        media-analyzer analyze audio.wav --language en --summary-length 500
    """
    try:
        # Initialize analyzer
        analyzer = Analyzer()
